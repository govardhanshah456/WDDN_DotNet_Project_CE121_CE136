    ...
    public partial class AdminBookInventory : System.Web.UI.Page
    {
        ...
        void deleteBookById()
        {
            if (checkIfBookExists())
            {
                try
                {
                    ...
                    SqlCommand cmd = new SqlCommand("DELETE from book_table WHERE book_id='" + TextBox1.Text.Trim() + "'", con);
        ...
        void updateBookById()
        {
            if (checkIfBookExists())
            {
                try
                {
                    ...
                    cmd.Parameters.AddWithValue("@author_name", DropDowmList3.SelectedItem.Value);
                    cmd.Parameters.AddWithValue("@publisher_name", DropDownList2.SelectedItem.Value);
                    cmd.Parameters.AddWithValue("@publish_date", TextBox5.Text.Trim());
                    cmd.Parameters.AddWithValue("@language", DropDowmList1.SelectedItem.Value);
        ...
        void getBookById()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("SELECT * from book_table WHERE book_id='" + TextBox1.Text.Trim() + "';", con);
                ...
                if (dt.Rows.Count >= 1)
                {
                    ...
                    DropDowmList1.SelectedValue = dt.Rows[0]["language"].ToString().Trim();
                    DropDownList2.SelectedValue = dt.Rows[0]["publisher_name"].ToString().Trim();
                    DropDowmList3.SelectedValue = dt.Rows[0]["author_name"].ToString().Trim();
        ...
        void fillAuthorPublisher()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("select author_name from author_login;", con);
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                DataTable dt = new DataTable();
                da.Fill(dt);
                DropDowmList3.DataSource = dt;
                DropDowmList3.DataValueField = "author_name";
                DropDowmList3.DataBind();
                cmd = new SqlCommand("select publisher_name from publisher_login;", con);
        ...
        bool checkIfBookExists()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("SELECT * from book_table where book_id='" + TextBox1.Text.Trim() + "' OR book_name='" + TextBox2.Text.Trim() + "';", con);
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                DataTable dt = new DataTable();
                da.Fill(dt);
